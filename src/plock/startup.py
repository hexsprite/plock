...
def interactive_debug_prompt(zope_conf='/Users/jbb/co/plock/plock/etc/zope.conf'):
...
def zdaemon_controller(zdaemon_conf='/Users/jbb/co/plock/plock/etc/zdaemon.conf'):
